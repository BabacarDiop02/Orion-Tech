...
export default function GlobalError({
  ...
  return (
    <main className="relative min-h-[100svh] flex flex-col items-center justify-center bg-midnight px-6 text-center">
      ...
      <h1 className="font-display text-4xl sm:text-6xl text-offwhite">SYSTÈME INTERROMPU.</h1>
      <p className="mt-6 max-w-md mx-auto text-orion-muted leading-relaxed">
        Une erreur est survenue de notre côté. Le signal sera rétabli sous peu.
      </p>
      <button
        type="button"
        onClick={reset}
