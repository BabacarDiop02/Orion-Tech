...
export default function Services() {
  ...
  return (
    <section id="services" className="relative bg-midnight py-28 lg:py-36">
        ...
        <div className="mt-16 border-t border-white/10">
          {SERVICES.map((service, i) => {
            ...
            return (
              ...
              >
                <span className="font-display text-sm text-orion-blue lg:col-span-1">
                  {service.number}
                </span>
                ...
                <p className="col-span-2 lg:col-span-6 text-orion-gray text-sm sm:text-base leading-relaxed lg:pl-4">
                  {service.description}
                </p>
